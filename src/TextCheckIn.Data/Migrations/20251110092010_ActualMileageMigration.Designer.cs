...
namespace TextCheckIn.Data.Migrations
{
    ...
    [Migration("20251110092010_ActualMileageMigration")]
    partial class ActualMileageMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TextCheckIn.Data.Entities.Service", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Price = 99.99m,
                            ServiceUuid = new Guid("eceed116-245a-4be3-9e6e-16ec807c6241"),
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
                });

            modelBuilder.Entity("TextCheckIn.Data.Entities.Sessions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
